...
public class GifRepository {
    private static final List<Gif> ALL_GIFS = Arrays.asList(
            new Gif("android-explosion", 0, LocalDate.of(2015,2,13), "Chris Ramacciotti", false),
            ...
            new Gif("infinite-andrew", 0, LocalDate.of(2015,8,23), "Marissa Mayer", true)
    );
    ...
    public List<Gif> findByCategoryId(int id) {
        List<Gif> gifs = ALL_GIFS.stream().filter(gif -> gif.getCategoryId() == id).collect(Collectors.toList());
        return gifs;
    }
